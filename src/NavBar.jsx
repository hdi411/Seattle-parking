  ...
  const tabs = [
    {
      ...
      label: 'Find',
      icon: (isActive) => (
        <svg width="24" height="24" viewBox="0 0 24 24" fill={isActive ? '#111827' : 'none'} stroke={isActive ? '#111827' : '#9ca3af'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      icon: (isActive) => (
        <svg width="24" height="24" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="12" r="10" fill={isActive ? '#3b82f6' : 'none'} stroke={isActive ? '#3b82f6' : '#9ca3af'} strokeWidth="2"/>
          <polyline points="12 6 12 12 16 14" fill="none" stroke={isActive ? '#fff' : '#9ca3af'} strokeWidth="2"/>
        </svg>
      ),
    },
    {
